...
load("ignore_workspaces/log1_BF.RData")
...
load("ignore_workspaces/log2_BF.RData")
```
...
# Load data
load("ignore_workspaces/logisticExample.RData")
...
```{r}
load("ignore_workspaces/freq1.RData")
```
...
# Full simulation
```{r loadData3}
load("ignore_workspaces/log3_BF.RData")
load("ignore_workspaces/freq1.RData")
load("ignore_workspaces/log3_extra_BF.RData")
