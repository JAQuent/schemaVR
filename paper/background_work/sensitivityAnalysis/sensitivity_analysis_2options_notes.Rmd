...
load("ignore_workspaces/nullData.RData")
```
...
load("ignore_workspaces/sensitivity_analysis_2options_beta1_equals_0_2.RData")
```
...
# Bayes factors 
```{r loadData3}
load("ignore_workspaces/nulldata_BF.RData")
...
```{r loadData4}
load("ignore_workspaces/sensitivity_analysis_option2_different_beta_BF.RData")
