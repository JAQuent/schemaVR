...
# Functions
genDat_logistic_recall <- function(numObj, numSub, gamma00, beta1, beta2, w1_SD, w2_SD, u01_SD, u02_SD){
...
# ----------------------------- Load data ---------------------------
# */
load('bayesianMM_recall_20190915_155300.RData')
...
sim_recall_data  <- genDat_logistic_recall(numObj, numSub, gamma00, beta1, beta2, w1_SD, w2_SD, u01_SD, u02_SD)
