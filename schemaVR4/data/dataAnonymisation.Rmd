---
title: "Anonymising data of schemaVR4"
...
In the next step, I am loading the already preprocessed data that was created with the schemaVR4_prepareDataset.R script.
```{r}
...
The age range of the participants (N = `r length(dataSchemaVR4_demo$age)`) was between `r ageMin` and `r ageMax` (Mean = `r round(ageMean, 2)`, SD = `r round(ageSD, 2)`). 
