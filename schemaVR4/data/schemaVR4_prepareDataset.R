...
subNum    <- c(1, 73, 2, 4, 5, 7, 6, 9, 10, 11, 12, 14, 13, 15, 17, 19, 21, 23, 20, 16, 25, 27, 29, 31, 33, 35, 37, 39, 74, 43, 75)

N        <- length(subNum)
setNum   <- c(111, 246, 388, 498, 848)

# Split in groups by subNum
group1  <- subNum[subNum %% 2 != 0]
group2  <- subNum[subNum %% 2 == 0]

# Load group 1
# File locations and names for data files
fileNam1 <- paste('Group 1 and 2/day2/schemaVR4_recall_', group1, '.txt', sep = "")
fileNam2 <- paste('Group 1 and 2/day2/correctionValues_', group1, '.txt', sep = "")
fileNam5 <- paste('Group 1 and 2/day2/ratingObjLoc_day2_', group1, '.dat', sep = "")
fileNam6 <- paste('Group 1 and 2/day2/ratingGen_day2_', group1, '.dat', sep = "")
fileNam7 <- paste('Group 1 and 2/day2/3AFC_day2_', group1, '.dat', sep = "")
fileNam8 <- paste('Group 1 and 2/day2/demographic_day2_', group1, '.txt', sep = "")

# Load group 2
# File locations and names for data files
fileNam1 <- c(fileNam1, paste('Group 1 and 2/day1/schemaVR4_recall_', group2, '.txt', sep = ""))
fileNam2 <- c(fileNam2, paste('Group 1 and 2/day1/correctionValues_', group2, '.txt', sep = ""))
fileNam5 <- c(fileNam5, paste('Group 1 and 2/day1/ratingObjLoc_day1_', group2, '.dat', sep = ""))
fileNam6 <- c(fileNam6, paste('Group 1 and 2/day1/ratingGen_day1_', group2, '.dat', sep = ""))
fileNam7 <- c(fileNam7, paste('Group 1 and 2/day1/3AFC_day1_', group2, '.dat', sep = ""))
fileNam8 <- c(fileNam8, paste('Group 1 and 2/day1/demographic_day1_', group2, '.txt', sep = ""))

# Load sets and input files
fileNam3 <- paste('sets/schemaVR3_encodingInputFile_VR_', setNum, '.txt', sep = "")
fileNam4 <- paste('sets/schemaVR4_3AFC_inputFile_', setNum, '.txt', sep = "")
...
# Imput missing values with the one of the same day for another participant (mean will )
correVal[6, 1] <- correVal[5, 1]
correVal[6, 2] <- correVal[5, 2]
...
for(i in 1:dim(dataRecall)[1]){
  if(!is.na(dataRecall$xPlaced[i])){
    ...
    # Calculating Euclidean distance between participants' placement and all twenty locations (i.e. spawn points).
