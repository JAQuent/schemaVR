...
load(paste0(path2parent, "/schemaVR2/analysis/schemaVR2_RK_exclusive_20210517_125304.RData"))
...
remembered[dataSchemaVR3_4$resCon == 2] <- NA_integer_ # Exclude familiar trials 
...
# ----------------------------- Saving image ---------------------------
# */
save.image(datedFileNam('schemaVR3_4_RK_exclusive_sequential', '.RData'))
