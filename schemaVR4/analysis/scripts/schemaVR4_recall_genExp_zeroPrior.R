# Script to run analysis of recall accuracy data for schemaVR4  (with general expectancy and zero priors)
# Version 1.0
# Date:  08/07/2021
...
dataSchemaVR4_recall$sGeneralRatingPost <- (dataSchemaVR4_recall$generalRatingPost - mean(dataSchemaVR4_recall$generalRatingPost ))/(sd(dataSchemaVR4_recall$generalRatingPost)/0.5)
...
# ----------------------------- Saving image ---------------------------
# */
save.image(datedFileNam('schemaVR4_recall_genExp_zeroPrior', '.RData'))