# Script to run analysis of AFC accuracy data for schemaVR4 (with general expectancy and zero priors)
# Version 1.0
# Date:  08/07/2021
...
dataSchemaVR4_AFC$sGeneralRatingPost <- (dataSchemaVR4_AFC$generalRatingPost - mean(dataSchemaVR4_AFC$generalRatingPost ))/(sd(dataSchemaVR4_AFC$generalRatingPost)/0.5)
...
# ----------------------------- Saving image ---------------------------
# */
save.image(datedFileNam('schemaVR4_AFC_genExp_zeroPrior', '.RData'))