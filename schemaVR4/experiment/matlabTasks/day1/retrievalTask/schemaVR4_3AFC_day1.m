function [ ] = schemaVR4_3AFC_day1(subNo, setNum)
%retrievalTask1 
% % % % % % % % % % % % % % % % % % % % % % % % % 
...
%% Setting everuthing up
    ...
    % Output files
    datafilename = strcat('data/3AFC_day1_',num2str(subNo),'.dat'); % name of data file to write to
    mSave        = strcat('data/3AFC_day1_',num2str(subNo),'.mat'); % name of another data file to write to (in .mat format)
    mSaveALL     = strcat('data/3AFC_day1_',num2str(subNo),'all.mat'); % name of another data file to write to (in .mat format)
