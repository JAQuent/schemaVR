...
# If everything works correctly, this script will download all .zip archives (nearly 11 GB in total) from OSF that contain the 
...
# If for any reason, R won't download the .zip files, just navigate to https://osf.io/4sw2t/ and download
...
# If the files don't unzip properly, unzip them manually in a folder called temporaryStorage and run from 
