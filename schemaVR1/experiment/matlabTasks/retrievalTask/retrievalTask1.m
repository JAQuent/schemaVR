...
%% Experimental loop
    for trial = 1:nTrial
        ...
        %% Confidence rating
        DrawFormattedText(myScreen, '0 = no memory | 1 = remember \n 2 = familiar | 3 = guess', 'center', 'center');
