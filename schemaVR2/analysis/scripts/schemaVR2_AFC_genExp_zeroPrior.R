# Script to run analysis of AFC accuracy data for schemaVR2 (with general expectancy and zero priors)
# Version 1.1
# Date:  34/06/2021
...
dataSchemaVR2_AFC$sGeneralRatingPost <- dataSchemaVR2_AFC$generalRatingPost/(sd(dataSchemaVR2_AFC$generalRatingPost)/0.5)
...
# ----------------------------- Saving image ---------------------------
# */
save.image(datedFileNam('schemaVR2_AFC_genExp_zeroPrior', '.RData'))