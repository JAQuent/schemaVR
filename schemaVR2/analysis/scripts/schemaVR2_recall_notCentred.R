# Script to run analysis of recall accuracy data for schemaVR2 (no demean but scaled version)
# Version 1.1
# Date:  23/06/2021
...
load(paste0(path2parent, "/schemaVR1/analysis/schemaVR1_recall_nodemean_20210324_175006.RData"))
...
# ----------------------------- Saving image ---------------------------
# */
save.image(datedFileNam('schemaVR2_recall_notCentred', '.RData'))