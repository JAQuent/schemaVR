---
title: "Anonymising data of schemaVR2"
...
The age range of the participants (N = `r length(dataSchemaVR2_demo$age)`) was between `r ageMin` and `r ageMax` (Mean = `r round(ageMean, 2)`, SD = `r round(ageSD, 2)`). 
