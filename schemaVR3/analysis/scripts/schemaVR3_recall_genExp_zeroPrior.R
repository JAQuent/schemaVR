# Script to run analysis of recall accuracy data for schemaVR3  (with general expectancy and zero priors)
# Version 1.0
# Date:  08/07/2021
...
dataSchemaVR3_recall$sGeneralRatingPost <- (dataSchemaVR3_recall$generalRatingPost - mean(dataSchemaVR3_recall$generalRatingPost ))/(sd(dataSchemaVR3_recall$generalRatingPost)/0.5)
...
# ----------------------------- Saving image ---------------------------
# */
save.image(datedFileNam('schemaVR3_recall_genExp_zeroPrior', '.RData'))