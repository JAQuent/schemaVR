# Script to run analysis of AFC accuracy data for schemaVR3 (with general expectancy and zero priors)
# Version 1.0
# Date:  08/07/2021
...
dataSchemaVR3_AFC$sGeneralRatingPost <- (dataSchemaVR3_AFC$generalRatingPost - mean(dataSchemaVR3_AFC$generalRatingPost ))/(sd(dataSchemaVR3_AFC$generalRatingPost)/0.5)
...
# ----------------------------- Saving image ---------------------------
# */
save.image(datedFileNam('schemaVR3_AFC_genExp_zeroPrior', '.RData'))