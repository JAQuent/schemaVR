function [ ] = schemaVR3_3AFC(subNo, setNum)
%retrievalTask1 
% % % % % % % % % % % % % % % % % % % % % % % % % 
% 3AFC recogntion location task for schemaVR3
...
%% Setting everuthing up
    ...
    % Creating trials
    [objectNumber, foil1Rank, encodingRank, foil2Rank, foil1Location, encodingLocation, foil2Location] = textread(strcat('schemaVR3_3AFC_inputFile_', num2str(setNum), '.txt'),'%n %n %n %n %n %n %n', 'delimiter','\t');
