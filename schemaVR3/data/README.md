The main data of this experiment (labelled Experiment 2) can be found in `dataSchemaVR3_cleaned.RData` in the data frames `dataSchemaVR3_AFC` and `dataSchemaVR3_recall`,  while the demographic data is found in `dataSchemaVR3_demo`.
